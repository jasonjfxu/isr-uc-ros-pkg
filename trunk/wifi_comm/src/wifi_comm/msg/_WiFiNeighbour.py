# autogenerated by genmsg_py from WiFiNeighbour.msg. Do not edit.
import roslib.message
import struct


class WiFiNeighbour(roslib.message.Message):
  _md5sum = "52868941085aea3ab1ea77d0d88e5d2d"
  _type = "wifi_comm/WiFiNeighbour"
...
"""
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(WiFiNeighbour, self).__init__(*args, **kwds)
