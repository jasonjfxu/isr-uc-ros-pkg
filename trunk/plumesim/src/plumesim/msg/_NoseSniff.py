...
class NoseSniff(roslib.message.Message):
  _md5sum = "206c81c40780de88c30ff719c4c4ae33"
...
"""
  __slots__ = ['header','sensor_model','reading','temperature_c','temperature_f','relative_humidity']
  ...
  ##   header,sensor_model,reading,temperature_c,temperature_f,relative_humidity
  ##
  ## @param self: self
  ...
  def serialize(self, buff):
    try:
      ...
      buff.write(struct.pack('<3f', self.temperature_c, self.temperature_f, self.relative_humidity))
  ...
  def deserialize(self, str):
    try:
      ...
      (self.temperature_c, self.temperature_f, self.relative_humidity,) = struct.unpack('<3f',str[start:end])
      return self
