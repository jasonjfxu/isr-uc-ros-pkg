...
class ReadPlumeSimResponse(roslib.message.Message):
  _md5sum = "1b09ec92371834b02dc6a357eee17bcf"
...
"""
  ...
  def serialize(self, buff):
    try:
      ...
      buff.write(struct.pack('<3f', self.sniff.temperature_c, self.sniff.temperature_f, self.sniff.relative_humidity))
    except struct.error, se: self._check_types(se)
    except TypeError, te: self._check_types(te)
  ...
  def deserialize(self, str):
    try:
      ...
      (self.sniff.temperature_c, self.sniff.temperature_f, self.sniff.relative_humidity,) = struct.unpack('<3f',str[start:end])
      return self
    except struct.error, e:
      raise roslib.message.DeserializationError(e) #most likely buffer underfill
...
class ReadPlumeSim(roslib.message.ServiceDefinition):
  ...
  _md5sum = 'feb0614af0208e151da3207ac5b81f56'
