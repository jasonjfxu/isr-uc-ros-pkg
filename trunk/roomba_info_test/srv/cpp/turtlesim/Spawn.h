/* auto-generated by gensrv_cpp from /home/pesty/ros-tutorials/ros_tutorials/turtlesim/srv/Spawn.srv.  Do not edit! */
#ifndef SRV_TURTLESIM_SPAWN_H
#define SRV_TURTLESIM_SPAWN_H
...
inline static std::string getDataType() { return "turtlesim/Spawn"; }
...
public:
  ...
  inline static std::string __s_getDataType() { return std::string("turtlesim/SpawnRequest"); }
  ...
  inline static std::string __s_getServiceDataType() { return std::string("turtlesim/Spawn"); }
...
public:
  ...
  inline static std::string __s_getDataType() { return std::string("turtlesim/SpawnResponse"); }
  inline static std::string __s_getMD5Sum() { return std::string(""); }
  inline static std::string __s_getMessageDefinition()
  {
    return std::string(
