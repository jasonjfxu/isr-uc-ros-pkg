/* auto-generated by gensrv_cpp from /home/pesty/ros-tutorials/ros_tutorials/roomba_info/srv/Kill.srv.  Do not edit! */
#ifndef SRV_ROOMBA_INFO_KILL_H
#define SRV_ROOMBA_INFO_KILL_H
...
inline static std::string getDataType() { return "roomba_info/Kill"; }
...
public:
  ...
  inline static std::string __s_getDataType() { return std::string("roomba_info/KillRequest"); }
  ...
  inline static std::string __s_getServiceDataType() { return std::string("roomba_info/Kill"); }
...
public:
  ...
  inline static std::string __s_getDataType() { return std::string("roomba_info/KillResponse"); }
  inline static std::string __s_getMD5Sum() { return std::string(""); }
  inline static std::string __s_getMessageDefinition()
  {
    return std::string(
