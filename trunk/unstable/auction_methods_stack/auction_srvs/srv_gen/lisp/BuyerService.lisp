...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BuyerService-request>)))
  ...
  "2e6332b25084caeadc25acc7c23c2c08")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BuyerService-request)))
  "Returns md5sum for a message object of type 'BuyerService-request"
  "2e6332b25084caeadc25acc7c23c2c08")
